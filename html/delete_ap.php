...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    $pid = $_GET['id'];
    $sql = 'delete from application where ap_id ='.$pid;
    
    if($stmt = mysqli_prepare($link, $sql)){
        if($stmt->execute()){
            header("location: delete_ap.php");
            exit;
        }
    }
...
<div class="container mt-4 justify-content-center">
    <div class="row justify-content-md-center">
            <div class="col-3">
                ...
                $sql="SELECT p.post_name, a.ap_id FROM posting p inner join application a on a.post_id = p.post_id where username = '";
                ...
                if($stmt = mysqli_prepare($link, $sql)){
                    ...
                    if($stmt->execute()){
                        ...
                        while($stmt->fetch()){
                            echo '<a href="delete_ap.php?id='.$post_id.'">';
